...
public final class MidiSource {
    ...
    private static String serverHostname = new String ("192.168.43.155"); // L'adresse du serveur
    private static int portNumber = 5000; // Le port du serveur
    ...
    private static void print(MidiMessage message) {
        if (message instanceof ShortMessage) {
            ...
            if (shortMessage.getCommand() != 240) { // some MIDI controllers continousouly output a 240 
                ...
                System.out.println();
            } if (shortMessage.getData1() == 48 & SM_FIELDS.get(shortMessage.getCommand()) == "NOTE_ON") {
				envoyerMessage("aller devant");
			} else if(shortMessage.getData1() == 49 & SM_FIELDS.get(shortMessage.getCommand()) == "NOTE_ON") {
				envoyerMessage("retourner en arrière");
			} else if(shortMessage.getData1() == 50 & SM_FIELDS.get(shortMessage.getCommand()) == "NOTE_ON") {
				envoyerMessage("tourner à droite" );
			}else if(shortMessage.getData1() == 51 & SM_FIELDS.get(shortMessage.getCommand()) == "NOTE_ON") {
				envoyerMessage("tourner à gauche");
			}else if(shortMessage.getData1() == 52 & SM_FIELDS.get(shortMessage.getCommand()) == "NOTE_ON") {
				envoyerMessage("stop");
			}else if(shortMessage.getData1() == 70 & SM_FIELDS.get(shortMessage.getCommand()) == "NOTE_ON") {
				carre();
			}else if(shortMessage.getData1() == 71 & SM_FIELDS.get(shortMessage.getCommand()) == "NOTE_ON") {
				triangle();
			}else if(shortMessage.getData1() == 72 & SM_FIELDS.get(shortMessage.getCommand()) == "NOTE_ON") {
				zigzag();
			}else if(shortMessage.getData1() == 60 & SM_FIELDS.get(shortMessage.getCommand()) == "NOTE_ON") {
				if( shortMessage.getData2() < 30 & SM_FIELDS.get(shortMessage.getCommand()) == "NOTE_ON") {
					envoyerMessage("moteur1 vitesse1");
				} else if ( shortMessage.getData2() >= 30 & shortMessage.getData2() < 60 & SM_FIELDS.get(shortMessage.getCommand()) == "NOTE_ON") {
					envoyerMessage("moteur1 vitesse2");
				} else if ( shortMessage.getData2() >= 60 & shortMessage.getData2() < 90 & SM_FIELDS.get(shortMessage.getCommand()) == "NOTE_ON") {
					envoyerMessage("moteur1 vitesse3");
				} else if ( shortMessage.getData2() >= 90 & SM_FIELDS.get(shortMessage.getCommand()) == "NOTE_ON") {
					envoyerMessage("moteur1 vitesse4");
				}
			}else if(shortMessage.getData1() == 62 & SM_FIELDS.get(shortMessage.getCommand()) == "NOTE_ON") {
				if( shortMessage.getData2() < 30 & SM_FIELDS.get(shortMessage.getCommand()) == "NOTE_ON") {
					envoyerMessage("moteur2 vitesse1");
				} else if ( shortMessage.getData2() >= 30 & shortMessage.getData2() < 60 & SM_FIELDS.get(shortMessage.getCommand()) == "NOTE_ON") {
					envoyerMessage("moteur2 vitesse2");
				} else if ( shortMessage.getData2() >= 60 & shortMessage.getData2() < 90 & SM_FIELDS.get(shortMessage.getCommand()) == "NOTE_ON") {
					envoyerMessage("moteur2 vitesse3");
				} else if ( shortMessage.getData2() >= 90 & SM_FIELDS.get(shortMessage.getCommand()) == "NOTE_ON") {
					envoyerMessage("moteur2 vitesse4");
				}
			}
    ...
    public void close() {
     ...
     public static void envoyerMessage(String mess){
